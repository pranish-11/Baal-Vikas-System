...
import { MessageCircle, Search, Paperclip, Send, Trash2 } from 'lucide-react';
import useSocket from '../hooks/useSocket';

export default function MessagesPage() {
  const { messages, setMessages, currentRole, openModal, sendMsg, setCurrentMsgId, currentMsgId, deleteConversation, user } = useApp();
