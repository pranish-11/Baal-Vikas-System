...
import { MessageCircle, Search, Paperclip, Send, Trash2, Edit2, Check, X } from 'lucide-react';
...
export default function MessagesPage() {
  ...
  const isOwnMessage = (msg) => {
    ...
    if (msg.authorId) return msg.authorId === user?.id;
    return msg.from_dir === 'out' || msg.from === 'out';
  };
